...
export function HeaderPage({
  ...
  return (
    <div className="relative overflow-hidden w-full rounded-2xl border border-border/80 bg-gradient-to-br from-primary/10 via-transparent to-primary/5 p-5 sm:p-8 shadow-sm flex flex-col lg:flex-row items-start lg:items-center lg:justify-between gap-4">
